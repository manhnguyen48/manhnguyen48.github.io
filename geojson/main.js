...
function main() {
    ...
    drawCanvasLayer("https://github.com/manhnguyen48/manhnguyen48.github.io/blob/master/geojson/London_updated.json", 'Clock Face hour', 'Conservative Factor');
    drawInfoLayer("https://github.com/manhnguyen48/manhnguyen48.github.io/blob/master/geojson/London_constituency.json", "Constituencies", style, onEachFeature, field_constituencies, alias_constituencies, 'black');
    drawInfoLayer("https://github.com/manhnguyen48/manhnguyen48.github.io/blob/master/geojson/London_updated.json", "Local Authorities", style, onEachFeature, field_LA, alias_LA, '#900C3F');
    drawInfoLayer("https://github.com/manhnguyen48/manhnguyen48.github.io/blob/master/geojson/London_ward.json", 'Wards', style, onEachFeature, field_ward, alias_ward, 'black');
}
